# Public Key
Represents a SIKEN public key and is needed to be able to receive SIKEN, as is usually represented as a SIKEN [Address](address.md). 

A PublicKey in SIKENcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = SIKENcore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new SIKENcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = SIKENcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
